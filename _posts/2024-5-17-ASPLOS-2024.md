...
在过道遇到Hao Ling，问能不能三句话让我懂：提出基于折叠片段的算法（log(n)），对ASan检查效率的改进奇高！
...
在Berkeley和康总（年纪轻轻就成为 startup co-founder，请收下我的膝盖！）早上逛完伯克利后，下午还是忍不住到Soda Hall去看心仪的AMPLab/RISELab的今身——SkyLab。对AMPLab/RISELab喜爱真的是因为太崇拜David Patterson了（John Hennessy 也爱）。
