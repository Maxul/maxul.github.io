...
- 反方观点：研究应该出于passion或curiosity，这样才容易引起innovation（not just AI）；当前ML还处于黑盒时代（可解释性还很弱），因此不同意ML is a new transistor的观点，因为晶体管以digital logic为基础，而digital logic是基于完全可解释可理解的布尔逻辑。作为计算机科学家，一定要知道什么是 foundation & fundamentals。
...
Zhipeng Jia：遇到目前在Google LLC的Zhipeng Jia (Boki@SOSP作者)，他说谷歌在follow the trend，内部researchers目前处于到处跟风蹭热点。论Tech Lead的Vision重要性！
